...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2021 at 01:44 PM
...
(23, '62928958', 'Jeric', 'Dumaguit', 'Baterna', 'HR', 'CEO', '2021-05-20', NULL),
...
(34, '84383691', 'Rehnan', 'Ybañez', 'Ramil', 'IT', 'Full stack Developer', '2021-05-29', NULL);
...
(7, 'Employee Java Application', 'IT', 'Complete', '2021-05-22 14:56:40', NULL, NULL),
(10, 'Todolist', 'IT', 'Complete', '2021-05-27 15:51:23', NULL, NULL);
...
CREATE TABLE `salary` (
  ...
  `employee_no` varchar(10) NOT NULL,
  `number_of_work_hours` int(255) NOT NULL,
...
(3, '62928958', 'gwapokokunuhay', 21, '09075841562', 'Male', '2021-05-20 14:23:07', NULL),
